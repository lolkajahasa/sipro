...
const CONTEXT_OPTIONS = [
  { value: "lead_stage:booking", label: "Lead — tahap Booking (keep unit)" },
  { value: "lead_stage:spr", label: "Lead — tahap SPR" },
  { value: "payment_scheme:kpr", label: "Skema bayar KPR" },
  { value: "payment_scheme:cash_bertahap", label: "Skema bayar Cash bertahap" },
  { value: "payment_scheme:cash_keras", label: "Skema bayar Cash keras" },
  { value: "customer:legal", label: "Customer — legal & administrasi" },
  { value: "partner:onboarding", label: "Mitra — pendaftaran" },
  { value: "unit:permit", label: "Unit — perizinan" },
];
