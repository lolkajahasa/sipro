...
const ORIGIN_LABEL = { default: "Bawaan sistem", org: "Diubah organisasi", project: "Khusus proyek" };
const SOURCE_LABEL = { DOC: "Dokumen legal", SISTEM: "Usulan sistem" };
    ...
    },
    {
      ...
      render: (r) => (
        <div className="space-y-0.5 text-xs">
          <div>{ORIGIN_LABEL[r.origin] || r.origin}</div>
          <div className="text-muted-foreground">Dasar: {SOURCE_LABEL[r.source] || r.source}</div>
          {r.updated_by ? (
