...
> Aturan tiap fase: (a) tidak boleh menurunkan 19 gate yang ada, (b) wajib gate baru yang **diuji-mutasi**, (c) wajib user story yang dibuktikan di browser, (d) tutup fase dengan update `plan.md` + `test_result.md` + status di dokumen V2.
...
|---|---|---|---|---|
| 39 | Fondasi Data & Wiring | XL | 22, 28, 33, 35 | `verify_masterplan.py`, `verify_settings.py` |
